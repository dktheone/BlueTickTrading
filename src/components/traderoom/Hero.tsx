        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          ...
          <div className="lg:col-span-7 space-y-6 text-center lg:text-left">
            ...
            <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-white/10 border border-white/20 text-[#2FFFB9] text-xs sm:text-sm font-semibold backdrop-blur-md">
              ...
              <span>15+ Years in Market • 10+ Years Time Cycle Research</span>
            </div>

            {/* Headline */}
            <h1 className="text-3xl sm:text-5xl lg:text-6xl font-extrabold text-white leading-[1.12] tracking-tight">
              Master Market Turn Dates with <span className="text-[#2FFFB9]">Time Cycle</span> Trading
            </h1>

            {/* Description */}
            <p className="text-sm sm:text-base md:text-lg text-slate-200 max-w-2xl mx-auto lg:mx-0 leading-relaxed font-normal">
              Stop getting trapped by lagging indicators. Learn how institutional traders forecast turning points in Nifty, BankNifty, and MCX Commodities using mathematical price-time squaring. Join Amit Gupta in our upcoming live masterclass.
            </p>
            ...
            <div className="pt-2 flex flex-col sm:flex-row items-center justify-center lg:justify-start gap-4">
              ...
              >
                <span>Reserve Free Webinar Seat</span>
              ...
              >
                <span>Explore Time Cycle Theory</span>
              </a>
            </div>
